...
var verifyToken = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res, next) {
    var token, decodedToken, user, passwordChanged;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          decodedToken = _jsonwebtoken["default"].verify(token, process.env.JWT_SECRET); // comprueba si el id del token corresponde a un usuario de la BBDD
          _context.next = 7;
        ...
        case 10:
          _context.next = 12;
          return user.isPasswordChanged(decodedToken.iat);
        case 12:
          passwordChanged = _context.sent;
          if (!passwordChanged) {
            _context.next = 15;
            break;
          }
        ...
        case 19:
          ...
          console.log('Error in token ', _context.t0);
      ...
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 6:
          ...
          return _context2.abrupt("return", res.status(403).json({
            status: "FAILED",
            message: "Unauthorized, you need to be an administrator."
          }));
        case 9:
