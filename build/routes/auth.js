...
router.post('/login', _auth.validateSingIn, _authController["default"].logIn).post('/logout', _auth2.verifyToken, _authController["default"].logOut).post('/forgotPassword', _auth.validateForgotPassword, _authController["default"].forgotPassword).patch('/resetPassword/:resetToken', _auth.validateResetPassword, _authController["default"].resetPassword);
