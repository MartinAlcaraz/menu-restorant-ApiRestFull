...
var ApiFeatures = /*#__PURE__*/function () {
  ...
  _createClass(ApiFeatures, [{
    ...
    value: function filter() {
      var queryObj = {};
      var queryObjAux = _objectSpread({}, this.queryString);
      var array = ["name", "price"]; // solo se permite filtrado por los elementos del array
      for (var key in queryObjAux) {
        if (array.includes(key)) queryObj[key] = queryObjAux[key];
      }
      var querySt = JSON.stringify(queryObj);
      querySt = querySt.replace(/\b(gt|gte|lt|lte|eq)\b/g, function (match) {
        return "$".concat(match);
      }); //e.g. replace gt by $gt
    ...
    value: function sort() {
      if (this.queryString.sort) {
        var sortBy = this.queryString.sort.split(',').join(' '); // {"sort":"price,name"} => {"sort":"price name"}
    ...
    key: "pagination",
    value: function () {
      var _pagination = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var page, limit, skip, count;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              skip = (page - 1) * limit; // tira error si se pide una pagina sin resultados //
              ...
              _context.next = 7;
              return _Product["default"].find(this.query);
            case 7:
              count = _context.sent;
              ...
              throw new _CustomError["default"]("Page not found", 404);
            case 10:
